      ...
      <section className="container">
        <div className="news-list-main nw-padding-top">
          ...
          <div className="back-white">
            <p>
              Мастер Групп ХХК-ийн гүйцэтгэж байгаа барилгын төслүүдэд татварын
              хууль тогтоомжийн хэрэглээний талаар хууль зүйн зөвлөх үйлчилгээг
              үзүүлэн ажиллаж байна. (2016-2017)
            </p>
            <span>
        ...
        if (disqus_shortname) {
            var	disqus_url = "http://elclawoffice.mn/post/135/123";
            (function() {
