...
export default function Page2WorkContentsEn() {
            ...
            >
              ...
              <li className="col-md-4">
                ...
                >
                  ...
                  <div className="desc">
                    <p />
                    <p>
                    Provided legal consulting services to the Toyotal Sales Mongolia LLC, distributer of Toyota LLC in Mongolia.</p>
                    <p />
                    <p>Toyota Sales Mongolia LLC was estabilished in December, 2012 and officially started its activity from January, 2018.</p>
                    <p />
                    <p>The main business activity of the Toyota Sales Mongolia LLC is to supply Toyota brand automobiles and the spare parts to its official dealers, but also support the operation of dealers, monitor its sales and service quality and provide them with the appropriate training etc.</p>
                  </div>
                </div>
              </li>
              <li className="col-md-4">
                <div
                  className="item back-white"
                  style={{ height: 440, cursor: "pointer" }}
              ...
              <li className="col-md-4">
                ...
                >
                  ...
                  <div className="desc">
                    ...
                    <p>Conducted due diligence, provided assistance and produced compatibility report on initial public offerings, selling shares on primary and secondary securities market, and raising necessary capital for “Ard Credit LLC”.</p>
                  </div>
                </div>
              </li>
              <li className="col-md-4">
                <div
                  className="item back-white"
                  style={{ height: 361, cursor: "pointer" }}
              ...
              <li className="col-md-4">
                ...
                >
                  ...
                  <span className="line" />
                  <div className="desc">
                    <p>Advised on entering into concession agreement to build high voltage power lines at a length of 110km in South Gobi region in the amount of USD 110 million and we successfully protected our client`&apos;`s interests at the court proceedings.</p>
                  </div>
                </div>
              </li>
              <li className="col-md-4">
                ...
                >
                  ...
                  <span className="line" />
                  <div className="desc">
                    <p>Advised on the franchising agreement and participated in negotiations for the Mongolian companies when purchasing the right to use a business`&apos;`s trademarks and associated brands in relation to the world renowned brands such as Hugo Boss, Emporio Armani, Ermenegildo Zegna, Burberry, Ulysse Nardin.</p>
                  </div>
                </div>
              </li>
              <li className="col-md-4">
                <div
                  className="item back-white"
                  style={{ height: 313, cursor: "pointer" }}
      ...
      >
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <h2>Incorporation of the representative office of the Sumitomo Mitsui Banking Corporation (October, 2013)
              </h2>
              <div className="wrap">
                <p>SMBC was formed by merging two largest banks in 2001 and it is one of the 20 world biggest banks in the world which is running activity establishing its branches and representative offices in the over 20 countries.   
                </p>
              </div>
            </div>
          </div>
